...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSPlacesClient.provideAPIKey("AIzaSyBVwK7atiVsDHHm4oaFxd39SALiwA-9rqw")
        GMSServices.provideAPIKey("AIzaSyBVwK7atiVsDHHm4oaFxd39SALiwA-9rqw")
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Project-App", withExtension: "momd")!
